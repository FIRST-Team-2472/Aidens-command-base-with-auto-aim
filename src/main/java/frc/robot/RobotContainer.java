...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    intake.setDefaultCommand(new IntakeControls(()-> rightJoy.getRawButton(2),()-> Xboxcontroller.getRightBumper(),() -> rightJoy.getRawButton(2),()-> Xboxcontroller.getRightBumper(), intake));
  }
